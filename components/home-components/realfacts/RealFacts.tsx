  ...
  return (
        <section className="bg-white dark:text-coolGray-100">
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-coolGray-50">Real Facts About GDF</h2>
                ...
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    <div>
                        <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-indigo-500 uppercase">Smart classes</h3>
                        <p className="mt-3 text-lg dark:text-coolGray-400">GDF SKILLS impart excellent teaching methodology and provide Smart Classroom for teaching and learning by integrating Learning Technology, such as Computers, Specialized Software, Audience Response Technology</p>
                    ...
                    <div aria-hidden="true" className="mt-10 lg:mt-0 block">
                        <Image width = "300" height = "200" layout = "responsive" src="https://images.unsplash.com/photo-1590402494682-cd3fb53b1f70?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8dGVhY2hlcnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-coolGray-500"/>
                    </div>
                </div>
                <div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        <div className="lg:col-start-2">
                            <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-indigo-500 uppercase">Job Oriented Courses</h3>
                        ...
                        <div className="block mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                            <Image width = "300" height = "200" layout = "responsive" src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8am9ifGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-coolGray-500"/>
                        </div>
                    </div>
                </div>
            </div>
