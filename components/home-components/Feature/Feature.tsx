  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
        <h2 className="max-w-lg mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl uppercase sm:leading-none md:mb-6 group">
          <span className="inline-block mb-1 sm:mb-4">
            Real facts About GDF
          </span>
          <div className="h-1 ml-auto duration-300 origin-left transform bg-pink-accent-400 scale-x-30 group-hover:scale-x-100" />
        </h2>
        ...
        <a href="/" aria-label="View Item">
          <div className="relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
            <img
              ...
              alt=""
            />
            <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 bg-pink-accent-400  bg-opacity-50  opacity-0 hover:opacity-100">
      ...
      <div className="text-center">
        <a
          href="/"
          aria-label=""
          className="inline-flex items-center font-semibold transition-colors duration-200 text-pink-accent-400 hover:text-deep-purple-800"
        >
          View gallery
          <svg
