    ...
    return(
        <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-coolGray-900 dark:text-coolGray-100">
            <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
                <div dangerouslySetInnerHTML={{ __html: userSvg!}} className="object-cover object-center w-full h-full rounded dark:bg-coolGray-500"/>
            </div>
            <div className="flex flex-col space-y-4">
                <div>
                    <h2 className="text-2xl font-semibold text-white">{session.user.name}</h2>
                    <span className="text-sm text-white">General manager</span>
                </div>
                <div className="space-y-1">
                    ...
                    <span className="flex items-center space-x-2">
                        ...
                        <span className="text-white">+25 381 77 983</span>
                    </span>
                </div>
            </div>
        </div>
