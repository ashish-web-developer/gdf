...
interface Props{
    ...
    menuState:boolean;
    session:any;
    setMenuState:(args:boolean)=>void;
}
let userSvg:string;
const DropDown:FC<Props> = ({children,menuState,session,setMenuState})=>{
    const {setProfilePopupState} = useProfilePopupContext();
      ...
      <div className="relative inline-block ">
        ...
        <div className="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800">
          <a href="#" className="flex items-center p-3 -mt-2 text-sm text-gray-600 transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            <div dangerouslySetInnerHTML={{ __html: userSvg}}  className="flex-shrink-0 object-cover mx-1 rounded-full w-9 h-9"/>
            <div className="mx-1">
          ...
          <button onClick = {()=>{setProfilePopupState(true);setMenuState(false)}} className="w-full flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
          ...
          <a href="#" className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M21 19H3C1.89543 19 1 18.1046 1 17V16H3V7C3 5.89543 3.89543 5 5 5H19C20.1046 5 21 5.89543 21 7V16H23V17C23 18.1046 22.1046 19 21 19ZM5 7V16H19V7H5Z" fill="currentColor" />
            </svg>
            <span className="mx-1">
              Keyboard shortcuts
            </span>
          ...
          <button onClick = {()=>signOut()} className="w-full flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
