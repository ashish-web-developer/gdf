...
import BookDemoPopup from "../components/home-components/BookDemo/BookDemoPopup";
import BookDemo from "../components/home-components/BookDemo/BookDemo";
import Feature from "../components/home-components/Feature/Feature";
...
const BookDemoStateContext = createContext<contextInterface>(undefined!);

const Home:NextPage = ()=>{
    const [state,setState] = useState<boolean>(false);
    const [notificationState,setNotificationState] = useState<boolean>(false);
    const [bookDemoState, setBookDemoState] = useState<boolean>(false);



    return(
        <>
        <BookDemoStateContext.Provider value = {{bookDemoState,setBookDemoState}}>
...
export default Home;
export {SignInButtonStateContext,NotificationPopupButtonStateContext,BookDemoStateContext};
